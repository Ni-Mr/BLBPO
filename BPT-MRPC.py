...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment_name", type=str, default='BPT-MRPC', help="实验名称")
    ...
    parser.add_argument("--save_ckpt_path", type=str, default="ckpt/BPT/MRPC",
    ...
    parser.add_argument("--test_ckpt_path", type=str, default="ckpt/BPT/MRPC/",
                        help="The path of the checkpoint params.")
