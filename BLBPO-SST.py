...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment_name", type=str, default='BLBPO-SST', help="实验名称")
    ...
    parser.add_argument("--save_ckpt_path", type=str, default="ckpt/BLBPO/SST", help="The path of the checkpoint params.")
    ...
    parser.add_argument("--test_ckpt_path", type=str, default="ckpt/BLBPO/SST",
