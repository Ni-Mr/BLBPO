...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_ckpt_path", type=str, default="ckpt/MRPC", help="The path of the checkpoint params.")
    ...
    parser.add_argument("--test_ckpt_path", type=str, default="ckpt/MRPC",
