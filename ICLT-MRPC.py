...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment_name", type=str, default='ICLT-MRPC', help="实验名称")
    ...
    parser.add_argument("--train_data_path", type=str, default='data/MRPC/train.pt', help="The path of the train data.")
    ...
    parser.add_argument("--save_ckpt_path", type=str, default="ckpt/ICLT/MRPC", help="The path of the checkpoint params.")
    ...
    parser.add_argument("--test_ckpt_path", type=str, default="ckpt/ICLT/MRPC/",
